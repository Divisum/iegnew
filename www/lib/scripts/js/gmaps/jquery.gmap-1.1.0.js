		...
		return this.each(function()
		{
			...
			else
			{
				...
				if (opts.latitude && opts.longitude)
				{
					...
					var miPosicion = new google.maps.LatLng(opts.latitude, opts.longitude);
					$gmap.setCenter(miPosicion);
				...
				else
				{
					...
					if ($.isArray(opts.markers) && opts.markers.length > 0)
					{
						...
						else
						{
							...
							var miPosicion = new google.maps.LatLng(opts.markers[0].latitude, opts.markers[0].longitude);
							$gmap.setCenter(miPosicion);
							$gmap.setZoom(opts.zoom);
						}
					...
					else
					{
						...
						var miPosicion = new google.maps.LatLng("34.885931", "9.84375");
						$gmap.setCenter(miPosicion);
						$gmap.setZoom(opts.zoom);							
